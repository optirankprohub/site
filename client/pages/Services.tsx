    ...
    >
      <div className={`h-full bg-gradient-to-br ${service.gradient} backdrop-blur-xl border border-slate-700/50 rounded-2xl p-8 hover:border-blue-500/30 transition-all duration-500 relative overflow-hidden`}>
        ...
        <div className="relative z-10">
          ...
          >
            <Button 
              className="w-full bg-gradient-to-r from-blue-500 to-blue-600 hover:from-blue-600 hover:to-blue-700 text-white py-4 rounded-xl shadow-lg shadow-blue-500/25 text-lg font-medium group/btn"
            >
              Get Started Today
  ...
  const mainServices = [
    {
      ...
      description: "Dominate search rankings with our comprehensive SEO strategies that drive organic traffic, improve visibility, and generate qualified leads for your business.",
      features: [
    ...
    },
    {
      ...
      description: "Maximize your advertising ROI with precision-targeted PPC campaigns across Google, Facebook, LinkedIn, and other high-converting platforms.",
      features: [
    ...
    },
    {
      ...
      description: "Build brand awareness and engage your audience through strategic social media campaigns that convert followers into loyal customers.",
      features: [
  ...
  const additionalServices = [
    {
      ...
      description: "Comprehensive data analysis and performance tracking to make informed decisions.",
      features: ["Custom Dashboards", "ROI Analysis", "Performance Tracking", "Competitive Intelligence"]
    },
    {
      icon: Globe,
      title: "Website Development & CRO",
      description: "High-converting websites optimized for performance and user experience.",
      features: ["Responsive Web Design", "Conversion Rate Optimization", "Speed Optimization", "A/B Testing"]
    },
    {
      icon: Mail,
      title: "Email Marketing Automation",
      description: "Nurture leads and retain customers with personalized email campaigns.",
      features: ["Email Campaign Design", "Marketing Automation", "Segmentation", "Performance Analytics"]
    },
    {
      icon: PenTool,
      title: "Content Marketing",
      description: "Engaging content that builds authority and drives organic growth.",
    ...
    },
    {
      ...
      features: ["App Store Optimization", "Mobile Advertising", "SMS Marketing", "Push Notifications"]
    },
    {
      icon: Users,
      title: "Brand Strategy & Consulting",
      description: "Comprehensive brand development and strategic consulting services.",
      features: ["Brand Identity", "Market Research", "Competitive Analysis", "Growth Strategy"]
    }
  ];
  ...
  const processSteps = [
    {
      ...
      description: "We analyze your business, competition, and market opportunities to create a tailored strategy.",
      icon: Eye
    },
    {
      step: "02",
      title: "Strategy Development",
      description: "Our experts develop a comprehensive digital marketing strategy aligned with your goals.",
      icon: Target
    },
    {
      step: "03",
      title: "Implementation",
      description: "We execute your campaigns with precision, using best practices and proven methodologies.",
      icon: Zap
    },
    {
      step: "04",
      title: "Optimization & Growth",
      description: "Continuous monitoring, testing, and optimization to maximize your ROI and growth.",
      icon: TrendingUp
    }
  ];
    ...
    <div className="min-h-screen bg-slate-900 text-slate-50 relative overflow-hidden">
        ...
        <div className="max-w-6xl mx-auto text-center">
          ...
          >
            ...
            >
              ...
              <span className="text-sm text-slate-300 font-medium">Complete Digital Marketing Solutions</span>
            </motion.div>

            {/* Headlines */}
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
              <span className="block text-white mb-4">Our Digital Marketing</span>
            ...
            <p className="text-xl md:text-2xl text-slate-300 max-w-4xl mx-auto leading-relaxed mb-12">
              From SEO to PPC, social media to analytics - we provide comprehensive digital marketing solutions 
              that drive growth, increase visibility, and maximize your ROI.
            </p>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              Our Core <span className="bg-gradient-to-r from-blue-400 to-blue-500 bg-clip-text text-transparent">Digital Solutions</span>
            </h2>
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Comprehensive digital marketing services designed to accelerate your growth and maximize ROI
            </p>
          </motion.div>
      ...
      <section className="py-24 relative">
        <div className="max-w-7xl mx-auto px-6">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              Additional <span className="bg-gradient-to-r from-blue-400 to-blue-500 bg-clip-text text-transparent">Specialized Services</span>
            </h2>
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              Complementary services to complete your digital marketing ecosystem
            </p>
          </motion.div>
      ...
      <section className="py-24 relative">
        <div className="max-w-6xl mx-auto px-6">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              Our Proven <span className="bg-gradient-to-r from-blue-400 to-blue-500 bg-clip-text text-transparent">Process</span>
            </h2>
            <p className="text-xl text-slate-300 max-w-3xl mx-auto">
              A systematic approach that ensures optimal results for every project
            </p>
          </motion.div>
      ...
      <section className="py-24 relative">
        ...
        <div className="max-w-4xl mx-auto px-6 text-center relative z-10">
          ...
          >
            <h2 className="text-4xl lg:text-5xl font-bold text-white mb-6">
              Ready to <span className="bg-gradient-to-r from-blue-400 to-blue-500 bg-clip-text text-transparent">Get Started</span>?
            </h2>
            <p className="text-xl text-slate-300 mb-10 max-w-2xl mx-auto">
              Let's discuss your digital marketing goals and create a customized strategy 
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
            ...
            <div className="space-y-4">
              ...
              <p className="text-slate-400 leading-relaxed">
                Professional digital marketing services that drive growth and maximize ROI for businesses worldwide.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                {["Home", "About Us", "Services", "Portfolio", "Contact"].map((link) => (
                  <li key={link}>
                    <Link to={`/${link.toLowerCase().replace(' ', '-')}`} className="hover:text-blue-400 transition-colors">
                      {link}
                    </Link>
                  </li>
                ))}
            ...
            <div>
              ...
              <ul className="space-y-2 text-slate-400">
                {["SEO", "PPC Advertising", "Social Media", "Web Development", "Analytics"].map((service) => (
                  <li key={service}>
            ...
            <div>
              ...
              <ul className="space-y-3 text-slate-400">
                ...
                <li>(555) 123-4567</li>
                <li>123 Marketing Street<br />Digital City, DC 12345</li>
              </ul>
            </div>
          </div>
